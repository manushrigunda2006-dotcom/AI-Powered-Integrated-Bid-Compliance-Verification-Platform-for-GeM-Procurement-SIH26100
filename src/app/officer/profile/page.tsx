...
export default function OfficerProfilePage() {
  ...
  const officer = {
    ...
    securityClearance: 'Class-3 PKI / Level-IV Authority',
    dscToken: {
      status: 'ACTIVE_VALID',
    ...
    recentAuditSignatures: [
      {
        ...
        bidder: 'CDEF Industries (Bidder 03)',
        tender: 'GEM/2026/B/894120 - Cloud Infrastructure',
        decision: 'DISQUALIFIED',
        reason: 'Rule 151 Debarment match on National Debarment registry (Central Procurement Authority)',
        status: 'DISQUALIFIED',
      },
      {
        id: 'sig-02',
        timestamp: '10-Sep-2026 11:20 IST',
        bidder: 'BCDE Solutions (Bidder 02)',
        tender: 'GEM/2026/B/894120 - Cloud Infrastructure',
        decision: 'CLARIFICATION REQUESTED',
        reason: 'Turnover ₹4.70 Cr falls short of ₹5.00 Cr minimum threshold; deterministic check flagged',
        status: 'CLARIFICATION',
      },
      {
        id: 'sig-03',
        timestamp: '09-Sep-2026 17:15 IST',
        bidder: 'ABCD Technologies (Bidder 01)',
        tender: 'GEM/2026/B/894120 - Cloud Infrastructure',
        decision: 'QUALIFIED',
        reason: '100% Deterministic rule pass (Turnover ₹5.20 Cr, GST Active, MAF Verified)',
        status: 'QUALIFIED',
      },
    ],
  };
